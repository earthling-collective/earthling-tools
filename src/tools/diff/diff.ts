// Line diff, dependency-free. The common prefix and suffix are trimmed first and
// the changed middle goes through LCS; a very large middle degrades to a plain
